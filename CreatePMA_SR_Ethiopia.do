...
/*Ethiopia SDP requested 2/21/2020 */
/*
Ethiopia R1 has different variable names for pills and injectables 
...
*	pay extra attention to PILLS & INJECTABLES  
	...
	use "$data/rawSDP/SDP_ETR2.dta", clear		
	foreach survey in $datalistminusone{
		...
		*tab round stock_sayana_press, m /*NONE yet*/
...
*	For now, only Kenya 
	...
	*Last round where JUST "injectables" was asked
	local last_round_inj 6
	*Three sets of datalist based on injectables variables
	global datalist1 "ETR2 ETR3 ETR4 ETR5 ETR6"  
	global datalist2 ""
