...
*	pay extra attention to PILLS & INJECTABLES  
	...
	use "$data/rawSDP/SDP_INRajasthanR1.dta", clear		
...
/*
* Practically, there's no implant. Very little injectables... 
	foreach survey in $datalist{
		use "$data/SR_`survey'.dta", clear
		tab xsurvey 
		
		#delimit; 
		sum	offer_stockout_implants 
...
*/
	...
	*			IMDIA SPECIFIC, EXCLUDE IMPLANTS IN CONSTRUCTING ESSENTIAL VARIABLES
	* Essential VERSION 1. based on service availability 
		...
		*gen byte essential5_offer=tempsum==5 
		gen byte essential5_offer=tempsum>=4 /*INDIA specific cause there's practically no implants*/
			drop temp*
		...
		*gen byte essential5ec_offer=tempsum>=6
		gen byte essential5ec_offer=tempsum>=5 /*INDIA specific cause there's practically no implants*/
			drop temp*
		...
		*gen byte temp_longact =offer_stockout_iud<=3 | offer_stockout_implants<=3 
		gen byte temp_longact =offer_stockout_iud<=3 /*INDIA specific cause there's practically no implants*/
		#delimit;
	...
	* Essential VERSION 2. based on current availability of methods 
		...
		*gen byte essential5_curav=tempsum>=5
		gen byte essential5_curav=tempsum>=4/*INDIA specific cause there's practically no implants*/
			drop temp*
		...
		*gen byte essential5ec_curav=tempsum>=6
		gen byte essential5ec_curav=tempsum>=5/*INDIA specific cause there's practically no implants*/
			drop temp*
		...
		*gen byte temp_longact =offer_stockout_iud<=2 | offer_stockout_implants<=2 
		gen byte temp_longact =offer_stockout_iud<=2 /*INDIA specific cause there's practically no implants*/
		#delimit;
		foreach var of varlist 	offer_stockout_injectables 
								offer_stockout_pill 
								offer_stockout_male_condoms{ ;
	...
	* Essential VERSION 3. based on current availability and no 3-mo stockout of methods 
		...
		*gen byte essential5_noso=tempsum>=5
		gen byte essential5_noso=tempsum>=4/*INDIA specific cause there's practically no implants*/
			drop temp*
		...
		*gen byte essential5ec_noso=tempsum>=6
		gen byte essential5ec_noso=tempsum>=5/*INDIA specific cause there's practically no implants*/
			drop temp*
		...
		*gen byte temp_longact =offer_stockout_iud<=1 | offer_stockout_implants<=1 
		gen byte temp_longact =offer_stockout_iud<=1 /*INDIA specific cause there's practically no implants*/
		#delimit;
		foreach var of varlist 	offer_stockout_injectables 
								offer_stockout_pill 
								offer_stockout_male_condoms{ ;
	...
	* Essential VERSION 4. based on current availability and readiness 
		...
		*gen byte essential5_ready=tempsum>=5
		gen byte essential5_ready=tempsum>=4 /*INDIA specific cause there's practically no implants*/
			drop temp*
		...
		*gen byte essential5ec_ready=tempsum>=6
		gen byte essential5ec_ready=tempsum>=5 /*INDIA specific cause there's practically no implants*/
			drop temp*
		...
		*gen byte temp_longact =ready_iud==1 | ready_implant==1
		gen byte temp_longact =ready_iud==1 /*INDIA specific cause there's practically no implants*/
		#delimit;
		foreach var of varlist 	offer_stockout_injectables 
								offer_stockout_pill 
								offer_stockout_male_condoms{ ;
