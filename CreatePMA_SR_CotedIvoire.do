...
*	pay extra attention to PILLS & INJECTABLES  
	...
	use "$data/rawSDP/SDP_CIR1.dta", clear		
	foreach survey in $datalistminusone{
		...
		*DATALIST1: rounds when JUST "injectables" was asked*/ =>round 1
		tab round stock_injectables, m 
		
		*DATALIST2: rounds when "sayana_press vs. depo_provera" was asked*/ => round2 
